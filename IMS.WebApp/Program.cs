...
/*builder.Services.AddDbContext<IMSContext>(options =>
{
    options.UseSqlServer(connectionString: builder.Configuration.GetConnectionString("InventoryManagement"));
});*/
//DI repositories
...
else
{
    ...
    // I may want to change this for production scenarios, see https://aka.ms/aspnetcore-hsts.
    app.UseHsts();
}
